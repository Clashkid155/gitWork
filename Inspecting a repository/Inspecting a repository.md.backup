...
Lesson on inspecting a repository, taken by instructor Francis.
...
<b><p style="text-align: center;">### Git Status</p></b>

## Git status
An easy but seriously powerful command, it displays the state of our repository. By 'state' i mean it shows which file has been modified, renamed, newly created and deleted in our repository.
...
![](/home/francis/Desktop/git_status.png)
<p style="text-align: center;">Output of Git status</p>

The screenshot shows files a typical output of `git status`.

**Untracked files** simply shows files that hasn't been added(staged) to the repository.

![](/home/francis/Pictures/git_status_add.png)
...
![](../../Pictures/git_status_noting.png)
...
<b><p style="text-align: center;">###Git log</p></b>
...
<b><p style="text-align: center;">###Git tag</p></b>
...
<b><p style="text-align: center;">###Git blame</p></b>
